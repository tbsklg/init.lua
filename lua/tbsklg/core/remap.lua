...
vim.keymap.set("n", "<leader>gfc", "<cmd>Telescope git_bcommits<cr>", { desc = "Find git commits for buffer" })
vim.keymap.set("n", "<leader>gb", "<cmd>Telescope git_branches<cr>", { desc = "Find git branches" })
vim.keymap.set("n", "<leader>gs", "<cmd>Telescope git_status<cr>", { desc = "Find git status" })
